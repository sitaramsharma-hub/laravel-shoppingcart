            ...
            <div class="col-md-7">
                <div class="bg-light right">
                    ...
                    <div class="d-flex mb-3">
                        ...
                        <small class="pt-1">({{ ($product->product_ratings_count>0)?$product->product_ratings_count. ' Reviews': $product->product_ratings_count. 'Review' }})</small>
                    </div>
                            ...
                            <div class="col-md-12 mt-5">
                                <div class="overall-rating mb-3">
                                    <div class="d-flex">
                                        ...
                                        <div class="pt-2 ps-2">({{ ($product->product_ratings_count>0)?$product->product_ratings_count. ' Reviews': $product->product_ratings_count. 'Review' }})</div>
                                    </div>
    ...
    <div class="container">
        ...
        <div class="col-md-12">
            <div id="related-products" class="carousel">
                ...
                @foreach($relatdProducts as $product)
                @php
                    ...
                    <div class="product-image position-relative">
                        @if(!empty($productImages))
                                    <a href="{{route('front.product',$product->slug)}}" class="product-img">                                       
                                     <img class="card-img-top" src="{{ asset('uploads/product/small/'.$productImages->image)}}" alt=""></a>
                                     @else
                                      <a href="{{route('front.product',$product->slug)}}" class="product-img"><img class="card-img-top" src="https://placehold.co/300" alt=""></a>
                                    @endif  
...
@section('customJs')
   <script>
        $('#ratingForm').submit(function(event){
            ...
            var element =  $(this);            
            $.ajax({
            url: '{{ route("front.saveRating", $product->id) }}',  // Verify the route name here
            type: 'POST',
        ...
        success: function(response) {
            if(response['status']== true){
                ...
                if(errors['review']){
                    ...
                    $("#review").removeClass('is-invalid').siblings('p')
                    .removeClass('invalid-feedback').html("");
                }
