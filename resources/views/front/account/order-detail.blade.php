            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-footer p-3">
                        ...
                        <!-- Heading -->
                        <h6 class="mb-7 h5 mt-4">Order Items ({{ $itemCount }})</h6>
                            ...
                            <li class="list-group-item">
                                <div class="row align-items-center">
                                    <div class="col-4 col-md-3 col-xl-2">
                                        <!-- Image -->
                                        @php
                                        $productImages =  getProductImage($item->product_id);    
                                        @endphp
                                        
                                        @if(!empty($productImages))
                                        <img class="img-fluid" src="{{ asset('uploads/product/small/'.$productImages->image)}}" alt="">
                                        @else
